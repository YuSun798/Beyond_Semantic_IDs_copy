...
three training runs and are not user-level confidence intervals. The
unrounded Beauty CQG-Single mean is \(0.0605166\), which rounds to \(0.0605\)
in main-paper Table 3; \(0.0597\) is not the mean of these three runs.
...
\toprule
Quartile & Method & 10 & 20 & 30 & 40 & 50 & 60 \\
\midrule
Q1 rare & Single & .0622 & \textbf{.1192} & \textbf{.1451} & \textbf{.1658} & .1865 & .1917 \\
($n=193$) & AR & \textbf{.0829} & .1088 & \textbf{.1451} & .1606 & .1762 & .1969 \\
& TIGER & .0674 & .1036 & .1347 & \textbf{.1658} & \textbf{.1917} & \textbf{.2021} \\
\midrule
Q2 & Single & \textbf{.1773} & \textbf{.2719} & \textbf{.3236} & \textbf{.3614} & \textbf{.3959} & \textbf{.4320} \\
($n=581$) & AR & .1497 & .2530 & .3098 & .3528 & .3907 & .4182 \\
& TIGER & .1756 & .2547 & .3133 & .3528 & .3873 & .4234 \\
\midrule
Q3 & Single & \textbf{.2519} & \textbf{.3449} & \textbf{.4206} & \textbf{.4675} & \textbf{.5030} & \textbf{.5310} \\
($n=1{,}322$) & AR & .2390 & .3434 & .4077 & .4486 & .4841 & .5204 \\
& TIGER & .2436 & .3411 & .4077 & .4508 & .4811 & .5091 \\
\midrule
Q4 popular & Single & \textbf{.3555} & \textbf{.4754} & \textbf{.5479} & \textbf{.5974} & \textbf{.6331} & \textbf{.6620} \\
($n=3{,}944$) & AR & .3494 & .4635 & .5319 & .5809 & .6174 & .6488 \\
& TIGER & .3474 & .4612 & .5307 & .5834 & .6273 & .6509 \\
\bottomrule
\end{tabular}
\end{minipage}\hfill%
\begin{minipage}[t]{0.495\textwidth}
...
\begin{tabular}{llrrrrrr}
\toprule
Quartile & Method & 70 & 80 & 90 & 100 & 120 & 150 \\
\midrule
Q1 rare & Single & .2124 & .2435 & \textbf{.2850} & \textbf{.2953} & \textbf{.3161} & \textbf{.3575} \\
($n=193$) & AR & \textbf{.2280} & .2487 & .2591 & .2642 & .3057 & .3368 \\
& TIGER & .2228 & \textbf{.2591} & .2642 & .2798 & .3057 & .3161 \\
\midrule
Q2 & Single & \textbf{.4509} & \textbf{.4802} & \textbf{.4923} & \textbf{.5112} & \textbf{.5508} & \textbf{.5835} \\
($n=581$) & AR & .4372 & .4613 & .4819 & .4974 & .5284 & .5645 \\
& TIGER & .4423 & .4647 & .4871 & .4991 & .5250 & .5611 \\
\midrule
Q3 & Single & \textbf{.5628} & \textbf{.5847} & \textbf{.6006} & \textbf{.6188} & \textbf{.6430} & \textbf{.6740} \\
($n=1{,}322$) & AR & .5461 & .5688 & .5840 & .6051 & .6339 & .6566 \\
& TIGER & .5363 & .5582 & .5809 & .5991 & .6316 & .6536 \\
\midrule
Q4 popular & Single & \textbf{.6864} & \textbf{.7039} & .7186 & \textbf{.7335} & .7571 & .7842 \\
($n=3{,}944$) & AR & .6747 & .6978 & .7125 & .7277 & .7497 & .7792 \\
& TIGER & .6795 & .7023 & \textbf{.7208} & \textbf{.7335} & \textbf{.7619} & \textbf{.7896} \\
\bottomrule
\end{tabular}
\end{minipage}
...
TIGER T5/RQ-VAE reproduction & N/A & N/A & N/A & N/A \\
\bottomrule
\end{tabular}
...
backbone and a 64-dimensional projection head. The closer T5/RQ-VAE
reproduction is reported from its released training interface; comparable
item/hidden/layer/head fields were not recorded in the available run artifact
and are marked N/A rather than left blank. SASRec uses at most 200 epochs on
...
\caption{Unified ML-1M objective diagnostics. (a) In the shared frozen item
space, full-catalog CE gives the highest R@10 for both CQG-Single and CQG-AR;
MSE and InfoNCE are lower. CE-joint changes the item representations and is
shown only as a separate diagnostic. (b) Replacing full-catalog CE with 256
sampled negatives reduces CQG-AR mean R@10 by 0.0087, showing that catalog
visibility explains part, but not all, of its behavior. Error bars denote
sample SD over seeds 42--44. (c) Lower softmax temperatures improve R@10 for
both continuous decoders in the evaluated range; the dashed line is the
CQG-Single MSE reference. This figure consolidates the results formerly
