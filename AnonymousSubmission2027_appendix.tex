...
\paragraph{MSE-trained candidate generation and reranking.}
...
CQG-Single on Beauty. Table~\ref{tab:mse-rerank} reports the standalone and
reranked results, while Table~\ref{tab:retrieval-hierarchy} compares the
learned retrievers with nonparametric candidate generators under the same
reranker. These are fixed-checkpoint diagnostics rather than multi-seed
primary results.
...
SASRec full-rank & 0.2797 & 0.0558 & \textbf{0.0390} \\
CQG-Single MSE standalone & 0.2425 & 0.0524 & 0.0307 \\
CQG-Single MSE + SASRec & 0.2801 & \textbf{0.0569} & 0.0381 \\
CQG-AR MSE standalone (seed 42) & 0.2414 & 0.0466 & 0.0294 \\
CQG-AR MSE + SASRec (seed 42) & 0.2791 & 0.0486 & 0.0378 \\
TIGER candidates + SASRec & \textbf{0.2864} & -- & -- \\
\midrule
\multicolumn{4}{l}{\textit{NDCG@10}} \\
SASRec full-rank & 0.1535 & 0.0296 & \textbf{0.0197} \\
CQG-Single MSE standalone & 0.1424 & 0.0266 & 0.0150 \\
CQG-Single MSE + SASRec & 0.1554 & \textbf{0.0308} & 0.0194 \\
CQG-AR MSE standalone (seed 42) & 0.1366 & 0.0276 & 0.0160 \\
CQG-AR MSE + SASRec (seed 42) & 0.1543 & 0.0265 & 0.0194 \\
TIGER candidates + SASRec & \textbf{0.1571} & -- & -- \\
\bottomrule
\end{tabular}
\caption{Matched Top-100 candidate-generation and reranking diagnostic.
CQG-Single uses MSE-trained checkpoints; CQG-AR uses the available seed-42
candidate outputs. TIGER reranking is available only for ML-1M. Bold denotes
the best reported result in each dataset and metric block.}
...
\begin{tabular}{lrr}
\toprule
Candidate generator & ML-1M R@10 & Sports R@10 \\
\midrule
Random & 0.0252 & 0.0037 \\
Last-item kNN & 0.2349 & 0.0311 \\
Mean-of-5 kNN & 0.2545 & 0.0310 \\
CQG-Single MSE + SASRec & \textbf{0.2801} & 0.0381 \\
CQG-AR MSE + SASRec & 0.2791 & 0.0378 \\
SASRec full-rank & 0.2797 & \textbf{0.0390} \\
\bottomrule
\end{tabular}
\caption{Candidate-generation hierarchy. All rows except SASRec full-rank
rerank a Top-100 candidate list with the same SASRec scorer. Bold denotes the
best result in each dataset column.}
