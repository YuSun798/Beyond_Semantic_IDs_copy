...
\begin{figure*}[t]
\centering
\includegraphics[width=0.75\textwidth]{Figures/whiteboard_exported_image (5).pdf}
...
intervals appear in Appendix C.2.}
\label{fig:crossover}
\end{figure*}
...
Full curve values and paired intervals are reported in Appendix C.2. The
